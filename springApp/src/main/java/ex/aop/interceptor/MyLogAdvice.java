...
/*
 - MethodInterceptor
 	...
 	: MethodBeforeAdvice, AfterReturningAdvice, ThrowsAdvice 세 가지의
...
public class MyLogAdvice implements MethodInterceptor {
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		// 대상 객체 메소드 호출 전 
		System.out.println(invocation.getMethod().getName()+" 메소드 호출전... ");
		...
		// 대상 객체 메소드 호출 후
		System.out.println(invocation.getMethod().getName()+" 메소드 호출후... ");
